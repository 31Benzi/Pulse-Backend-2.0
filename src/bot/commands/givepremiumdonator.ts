...
export const givepremiumdonatorCommand = {
    data: new SlashCommandBuilder()
        .setName("givepremiumdonator")
        .setDescription("Give Premium Donator items to a user (Admin only)")
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const embed = new EmbedBuilder()
            .setColor(0xF1C40F)
            .setTitle("Premium Donator Items Given")
            .setDescription(`**${username}** has been given Premium Donator items!`)
            .addFields(
                { name: "Premium Items Added", value: `${addedCount} new items`, inline: true },
